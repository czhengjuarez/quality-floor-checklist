...
var isAbsolutePath = /* @__PURE__ */ __name((path) => {
...
var windowsPathToUnixPath = /* @__PURE__ */ __name((path) => {
  return path.replace(/^[a-zA-Z]:/, "").replace(/\\/g, "/");
}, "windowsPathToUnixPath");
...
app.put("/api/todos/:id", async (c) => {
  try {
    ...
    todos[index] = { ...todos[index], ...updates, updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
    await c.env.CHECKLIST_BUCKET.put("todos.json", JSON.stringify({ todos }));
...
// .wrangler/tmp/bundle-28dcQV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-28dcQV/middleware-loader.entry.ts
